...
function recognizeDigits(){for(const i of state.islands){i.value=1;i.confidence=0;}}
...
draw();render();
(function(){const s=document.createElement('script');s.src='ocr-perfect.js?v=final4';document.body.appendChild(s);})();